...
export default function ShareClubPage() {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-start pt-12 md:pt-16 px-4 w-full text-red-500">
        <p>{error}</p>
        <Button
          onClick={() => router.back()}
          variant="outline"
...
function ShareClubPageContent({
  ...
  return (
    <div className="flex flex-col items-center justify-start pt-12 md:pt-16 px-4 w-full h-[90%]">
      <Button
        variant="ghost"
        size="icon"
        onClick={() => router.back()}
